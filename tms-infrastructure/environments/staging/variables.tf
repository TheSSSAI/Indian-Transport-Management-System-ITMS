...
# This file declares all variables needed to compose the full 'staging' infrastructure.
...
variable "rds_multi_az" {
  description = "Flag to enable Multi-AZ deployment for RDS. Per REQ-1-502, should be true for staging."
  type        = bool
}
