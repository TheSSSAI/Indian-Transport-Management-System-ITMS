...
# This file declares all variables needed to compose the full 'dev' infrastructure.
...
variable "rds_multi_az" {
  description = "Flag to enable Multi-AZ deployment for RDS. Per REQ-1-502, should be false for dev, true for prod."
  type        = bool
}
